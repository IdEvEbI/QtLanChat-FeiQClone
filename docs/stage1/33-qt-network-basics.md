...
- **实际需求**：开发局域网聊天软件需要深入理解网络基础概念。IP、端口、子网掩码、广播、多播等概念是网络编程的基石，理解这些概念才能正确使用 Qt Network 模块
- **应用场景**：局域网设备发现、群组聊天、文件传输、在线游戏、物联网设备通信
...
| **255.255.255.252** | /30       | 前 30 位是网络地址（点对点） |
...
| **应用场景** | 局域网设备发现、简单消息广播 | 群组聊天、视频会议、在线游戏        | 局域网聊天、文件共享     |
