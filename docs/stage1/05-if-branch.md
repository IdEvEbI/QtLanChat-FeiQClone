...
**类比**：就像成绩评定，90 分以上是优秀，80-89 是良好，60-79 是及格，60 以下是不及格
...
1. **关于 if-else 语句，下列说法正确的是：**
   ...
   **解析**：
   ...
   - **错误答案 B**：else if 可以多个，但不是无限多个，过多会影响可读性
...
2. **关于嵌套 if-else，下列说法正确的是：**
   ...
   **解析**：
   - **正确答案 B**：深度嵌套会降低代码可读性，建议不超过 2-3 层
   - **错误答案 A**：虽然语法允许，但过深嵌套会让代码难以理解
