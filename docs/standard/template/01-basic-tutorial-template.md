...
### 2.2 基础语法（或知识认知，根据主题选择）

{C++ 相关的语法介绍或知识认知，如：支持的数据类型、语法规则、命名规范等}

#### 2.2.1 基本语法规则

- **规则 1**：{说明规则和用途，配合生活化比喻}
- **规则 2**：{说明规则和用途，配合生活化比喻}
...
- **文件位置**：`src/stage1/{文档编号}-{文档名}/01-basic-example.cpp`
- **文件内容**：与上面示例完全一致的程序
...
> **新知识点说明**：{新知识点定义和作用}。{类比说明（生活化比喻）}。这是{应用场景}的基础方法，在后续的{相关章节}会详细讲解。
...
### 2.4 命名原则（可选 - 适用于变量、函数、类等）

{命名规范说明，如：变量命名要见名知义、遵循 C++ 开发规范等}
