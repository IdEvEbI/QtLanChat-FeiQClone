...
### 多文件开发基础（0% 完成）**新增 - 阶段 1 扩展，最高优先级**

- [ ] 24-multi-file-basics.md（多文件开发基础：头文件、源文件分离、编译链接、Cursor 调试）- 1.5h
  - 为什么需要多文件开发
...
**新增核心文档**：100% 完成基础部分
**多文件开发基础**：0% 完成（预计 1.5h）**新增 - 阶段 1 扩展，最高优先级**
...
**里程碑 5**：多文件开发基础（24）⏳ 0% 完成**新增 - 阶段 1 扩展，最高优先级**

- ⏳ 24-multi-file-basics.md（多文件开发基础）**最高优先级**
...
**立即任务**：开始编写 24-multi-file-basics.md（多文件开发基础）**最高优先级**
**本周目标**：完成 24-multi-file-basics.md（多文件开发基础，1.5h）+ 25-stl-containers-advanced.md（STL 容器进阶，2h）
**中期目标**：完成多文件开发基础（24，1.5h）+ C++ 进阶语法（25-27，4.5h）+ 多文件开发进阶（28，1.5h）
**重点文档**：24-multi-file-basics.md（多文件开发基础，最高优先级，确保学生能在 Cursor 中编译、执行、调试多文件项目）
...
**需要在 24-multi-file-basics.md 中补充的知识点：**

- ⏳ **头文件保护（include guard / #pragma once）**：避免重复包含
- ⏳ **多文件编译**：编译多个 .cpp 文件、链接过程、Makefile 基础
