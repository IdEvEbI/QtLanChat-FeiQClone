...
> **学习定位**：3 周教程式学习，掌握 C++ 基础、Qt 开发规范、UI 设计、网络通信等核心技能
...
**预期收获**：3 周后能够独立开发局域网即时通讯软件，支持 200 人并发，掌握完整的 C++ Qt 开发技能栈。
...
| 版本     | 状态      | 功能                | 发布时间   | 对应阶段 |
| -------- | --------- | ------------------- | ---------- | -------- |
| **v0.1** | 🔄 开发中 | C++ 基础 + Qt 环境  | 2025-10-27 | 阶段 1   |
| **v0.2** | 📋 规划中 | Qt 环境 + 开发规范  | 2025-10-28 | 阶段 2   |
| **v0.3** | 📋 规划中 | UI 设计 + 交互逻辑  | 2025-10-31 | 阶段 3   |
| **v0.4** | 📋 规划中 | 网络通信 + 数据传输 | 2025-11-04 | 阶段 4   |
| **v0.5** | 📋 规划中 | 测试 + 性能优化     | 2025-11-08 | 阶段 5   |
| **v1.0** | 📋 规划中 | 集成 + 开源发布     | 2025-11-10 | 阶段 6   |
